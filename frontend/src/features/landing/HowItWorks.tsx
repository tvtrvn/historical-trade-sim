...
export function HowItWorks() {
  return (
    <section className="relative max-w-[1280px] mx-auto px-4 sm:px-6 py-16 sm:py-20">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <span className="font-display text-[42px] leading-[1] tracking-tight text-aurum/70 tabular">
              ...
              <h3 className="mt-5 text-[16.5px] font-semibold tracking-tight text-text-primary">
                {step.title}
              </h3>
              <p className="mt-2 text-text-secondary text-[14px] leading-relaxed">{step.body}</p>
              {i < 2 ? (
