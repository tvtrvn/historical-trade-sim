  ...
  return (
    <>
      <motion.header
        ...
        className="fixed top-3 left-3 right-3 sm:top-4 sm:left-4 sm:right-4 z-50 mx-auto max-w-[1280px]"
      >
        <div className="glass rounded-md flex items-center justify-between gap-2 pl-3 pr-2 sm:px-4 h-14">
          <NavLink to="/" className="flex items-center gap-2 cursor-pointer group min-w-0">
            <BrandMark />
            <span className="font-display text-[14px] sm:text-[15px] tracking-tight text-text-primary group-hover:text-white transition-colors truncate">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            {NAV.slice(1).map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  classNames(
                    'group relative px-3 h-9 inline-flex items-center gap-2 rounded-sm text-[13px] whitespace-nowrap',
      ...
      {open ? (
        <>
          ...
          <motion.div
            ...
            className="lg:hidden fixed top-[76px] left-3 right-3 sm:left-4 sm:right-4 z-40 mx-auto max-w-[1280px]"
          >
                ...
                {NAV.map((item) => (
                  <li key={item.to}>
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        classNames(
                          'flex items-center gap-3 h-12 px-3 rounded-sm text-[14px]',
