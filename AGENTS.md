...
This project is indexed by GitNexus as **historical-trade-sim** (1680 symbols, 3065 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
